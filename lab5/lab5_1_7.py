...
makeGraph("Zadanie śledzenia trajektorii (u_D zamiast u_FF) dla $\omega = 1$", res)
...
makeGraph("Zadanie śledzenia trajektorii (u_D zamiast u_FF) dla $\omega = 5$", res)
...
makeGraph("Zadanie śledzenia trajektorii (u_D zamiast u_FF) dla $\omega = 10$", res)
